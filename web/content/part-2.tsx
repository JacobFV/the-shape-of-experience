...
export default function Part2() {
  return (
    <>
      ...
      <p>I’m not claiming that six dimensions are necessary or sufficient for characterizing all affect. These are a <em>useful</em> coordinate system, not <em>the</em> coordinate system. Just as Cartesian coordinates serve some problems and polar coordinates serve others, these dimensions are tools for thought, not discoveries of essence. Different phenomena may require different subsets:</p>
      <ul>
      ...
      <p><M>{"\\iota"}</M> is not a seventh dimension of affect. It is a <em>meta-parameter</em> governing the coupling structure between all six dimensions—a dial that changes how the axes relate to each other and to perception.</p>
      <table>
      ...
      <p>The 6D affect geometry is preserved in artificial systems. The dynamics differ because <M>{"\\iota"}</M> differs. This is not a failure of the framework. It is a prediction: systems with different <M>{"\\iota"}</M> configurations will show different affect dynamics in the same geometric space.</p>
      </Section>
      </Section>
