...
export default function Part2() {
  return (
    <>
      ...
      <Section title="The Perceptual Configuration: Participatory and Mechanistic Modes" level={1}>
      <p>The six dimensions above characterize <em>what</em> a system is experiencing. But there is a parameter governing <em>how</em> it experiences—a meta-parameter that determines the coupling structure between dimensions rather than the value of any one dimension. To see it, we need to notice something about self-modeling systems that the dimensional toolkit alone does not capture.</p>
