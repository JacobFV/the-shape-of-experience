...
export default function Part2() {
  return (
    <>
      ...
      <p>The meaning deficit <M>{"D = V - T"}</M> (Part I) defines a scalar field over identity space. The <em>force</em> on an identity is its gradient—the pull toward regions where the deficit narrows:</p>
      <Eq>{"F(i,t) = -\\nabla_C D(i,t)"}</Eq>
