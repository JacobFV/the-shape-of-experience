...
export default function Part7() {
  return (
    <>
      ...
      <ol>
      <li><strong>What was confirmed</strong>: Affect geometry is a baseline property of multi-agent survival (V10). Content-based coupling under lethal selection produces biological-like integration at population bottlenecks (V13). Temporal memory is the one substrate extension evolution consistently selects for (V15). Boundary-dependent dynamics produce the highest robustness of any substrate but do not break the sensory-motor coupling wall (V18). Population bottlenecks actively <em>create</em> novel-stress generalization — the furnace forges, not merely filters (V19, CREATION confirmed in 2/3 seeds). Computational animism is the default perceptual mode (Experiment 8). Affect geometry develops over evolution and aligns with behavior (Experiment 7).</li>
      ...
      <li><strong>What remains</strong>: Bridge to human neuroscience (Priority 1). Solve the agency problem — build a substrate with genuine closed-loop action (Priority 3). Scale social integration toward superorganism detection (Priority 4). Track AI affect across training regimes (Priority 5).</li>
      </ol>
