...
export default function Part7() {
  return (
    <>
      ...
      <li><strong>What remains</strong>: Bridge to human neuroscience (Priority 1). V20b with stronger multi-agent coordination pressure to develop language precursors (Priority 3). Scale social integration toward superorganism detection (Priority 4). Track AI affect across training regimes (Priority 5).</li>
      </ol>
