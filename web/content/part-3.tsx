...
export default function Part3() {
  return (
    <>
      ...
      <Sidebar title="Scarcity, Sacredness, and Consecration">
      <p>There is a general mechanism beneath religion's meaning-generating power that deserves separate treatment: <em>prohibition amplifies signal</em>. When a desire is forbidden, the nervous system routes it through a covert channel—secrecy, fantasy, hidden attention—and the covert channel <em>amplifies</em> the signal. The forbidden thing glows. Scarcity generates meaning in the same way that rarity generates economic value: not because the object is intrinsically more significant but because the constraint structure around it concentrates attention and affect. A child raised in a high-constraint moral system (JW, fundamentalist, authoritarian) experiences desire as sacred because the prohibition makes it feel cosmically charged—as though wanting itself were a plot point in a divine narrative. When the prohibition lifts—through development, through leaving the community, through confrontation with mortality—the sacred aura collapses. The world does not end. The desire is just a desire. And the person experiences meaning-loss proportional to how much meaning was anchored to the prohibition rather than to the content.</p>
      <p>This is why leaving religion feels like meaning-death even when the beliefs were false. The beliefs were the scaffolding; the prohibition was the amplifier; the affect was real. What collapses is not the desire but the <em>container</em> that made the desire feel like it pointed somewhere beyond itself. The adult replacement is what we might call <em>consecration</em>: the deliberate choice to treat something as significant and protect it with behavior. Sacredness is externally granted and taboo-protected—it depends on the constraint system that installed it. Consecration is self-granted and commitment-protected—it depends on the person choosing to care. The difference: sacredness collapses when the prohibition lifts. Consecration persists because it was never anchored to prohibition in the first place. "I treat intimacy as consequential" is consecration—not because God watches, but because I do. This is the only kind of meaning that survives the transition from childhood to adulthood, from religion to autonomy, from received significance to constructed significance. And it is, structurally, what every contemplative tradition has been trying to teach: meaning is not found in the object or granted by the constraint but cultivated through the quality of attention you bring.</p>
      </Sidebar>
      <Sidebar title="The Mortality Interrupt">
      <p>Confrontation with death as final—not as theological abstraction but as somatic encounter—operates as a forced world-model reset. The mechanism: the self-model contains a viability boundary <M>{"\\partial V"}</M>, and the death-belief structure determines where that boundary is located and what lies beyond it. A system raised with an afterlife buffer (resurrection, reincarnation, heaven) has its <M>{"\\partial V"}</M> softened—death is a transition, not a terminus, and the viability gradient is blunted by the expected continuation. When the afterlife buffer is removed—through intellectual development, through confrontation with actual danger—the boundary hardens. Death becomes irreversible. And the system's valence calculation changes: if this life is the only life, then every moment has sharper gradients, every choice is more consequential, every approach to the boundary is more terrifying and more clarifying.</p>
      <p>The mortality interrupt has a distinctive double effect. First, it collapses the external permission hierarchy—the supernatural observer dissolves, guilt loosens, the system moves from "I am judged for wanting" to "I am responsible for what I do with wanting." Second, it grounds the preference for continued existence somatically rather than doctrinally—the body votes, and its vote overrides years of ideation. A person who has been building a case for not existing discovers, in actual danger, that the case was never endorsed by the system it purported to represent. The nervous system's preference for continuation is not an argument; it is a structural feature of viability-maintaining systems. The mortality interrupt makes this preference viscerally available, and the resulting reorientation—from "life is optional" to "life is a scarce resource"—can restructure the entire value function in a way that years of therapy or philosophical argument cannot.</p>
      </Sidebar>
      </Section>
