...
export default function Part1() {
  return (
    <>
      ...
      <p>V13–V18 extended this program with six additional substrate variants and twelve measurement experiments, sharpening the conclusion considerably. The geometry is confirmed more strongly: affect dimensions develop over evolution (Exp 7), the participatory default is universal and selectable (Exp 8), and collective coupling amplifies individual integration (Exp 9). But the dynamics wall is now located precisely: at what Part VII calls rung 8 of the emergence ladder — the point where counterfactual sensitivity and self-modeling become operational. Substrate engineering (memory channels, attention, signaling, insulation fields) cannot cross this rung because all variants share the same architectural limitation: no genuine action→environment→observation causal loop. The patterns cannot act on the world and observe the consequences; they are always internally driven. Not "biography" as a vague metaphor, then, but "embodied agency" as a specific architectural requirement: the dynamics of affect require a substrate in which actions have consequences that return as observations.</p>
