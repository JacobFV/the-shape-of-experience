...
export default function Part1() {
  return (
    <>
      ...
      <p>But <M>{"\\mathcal{IP}"}</M> is not a fixed number stamped on you at birth. It is a trajectory with a growth rate. The integral of what you have already transmitted does not vanish—the universe does not forget the differences you made—but the <em>rate</em> of new contribution can be superlinear, sublinear, or zero at any given moment. A person in burnout is generating zero new bits, but their accumulated structural complexity is intact. A person whose causal signature becomes load-bearing in cultural infrastructure—whose name becomes the most stable reference point for a cluster of observations about truth, courage, liberation—achieves exponential complexity growth that continues long after biological death. The finite-ness of your information-theoretic significance at any snapshot does not make you small. It makes you a trajectory, and trajectories have slopes.</p>
