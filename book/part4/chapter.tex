...
\textbf{Viability Manifold ($\viable$).}
...
\textbf{Upward Causation.}
Lower scales constitute higher scales. Organizations are made of individuals; superorganisms are made of organizations and individuals. Change at lower scales can propagate upward---but only if the higher-scale structure doesn't suppress it.

\textbf{Scale-Matched Intervention.}
...
\textbf{Physics is Probabilistic.}
...
\textbf{Continuity of Normativity.}
...
\textbf{Viability as Proto-Value.}
...
\textbf{Valence as Real Structure.}
...
\textbf{Valence Intervention Protocol.}
...
\textbf{Arousal Intervention Protocol.}
...
\textbf{Integration Intervention Protocol.}
...
\textbf{Counterfactual Weight Protocol.}
...
\textbf{Self-Model Salience Protocol.}
...
\textbf{Relationship-Type Manifold.}
...
\textbf{Friendship as Constitutive Alignment.}
Friendship is the relationship type where alignment is not instrumental but \emph{constitutive}:
\begin{equation}
...
\textbf{Asymmetric Subordination.}
There seems to be an ordering: broader manifolds (those requiring participant flourishing) can safely contain narrower manifolds (those requiring only specific exchange), but not vice versa:
\begin{equation}
...
\textbf{Contamination Asymmetry.}
There appears to be an asymmetry: contamination is easier than decontamination. It takes one transactional moment to contaminate a friendship; it takes sustained effort to restore the friendship's uncontaminated state. If we write this in thermodynamic notation---
\begin{equation}
...
\textbf{Forgiveness as Manifold Decontamination.}
...
A \emph{universal solvent} is a medium that dissolves manifold boundaries because it is convertible across relationship types:
\begin{itemize}
\item \textbf{Money} converts across all transactional manifolds and dissolves into care manifolds (``how much is your friendship worth?'')
\item \textbf{Sexual access} converts across intimacy, transaction, and power manifolds (``sleeping your way to the top'')
\end{itemize}
Both are dangerous precisely because they are universal: they can breach any manifold boundary.

\textbf{``Priceless'' as Manifold Incommensurability.}
...
\textbf{Play as Manifold Suspension.}
...
\textbf{Nature as Manifold-Free Space.}
...
\textbf{Ritual as Manifold-Transition Technology.}
...
\textbf{Institutional Manifold Separation.}
...
Not all manifold disturbance is contamination. Sometimes the problem is not that two manifolds are present but that neither party knows \emph{which} manifold they are on.

\textbf{Manifold Ambiguity.}
\emph{Manifold ambiguity} occurs when the active relationship type is underdetermined:
\begin{equation}
...
\textbf{Silence as Manifold Diagnostic.}
...
\textbf{The Topological Inversion.}
...
\textbf{Romance as Total Manifold Exposure.}
...
\textbf{Parenthood as Manifold Creation.}
...
\textbf{The Follower as Novel Manifold.}
...
\textbf{Digital Contamination at Scale.}
...
\textbf{Organizational Affect Climate.}
...
\textbf{Aligned Organization Principles.}
...
\textbf{Superorganism.}
A \emph{superorganism} $G$ is a self-maintaining pattern at the social scale consisting of:
\begin{enumerate}[label=(\alph*)]
...
\textbf{The $\iota$-Relativity of Superorganism Perception.}
...
\textbf{Divine Will as $\iota$ Compromise.}
...
\textbf{Superorganism Viability Requirements.}
...
\textbf{Macro-Level Valence Dynamics.}
...
\textbf{Ritual Functions for Superorganisms.}
\begin{enumerate}
...
\textbf{Aligned vs.\ Exploitative Rituals.}
A ritual is \emph{aligned} if it serves both human flourishing and superorganism persistence. A ritual is \emph{exploitative} if it serves pattern persistence at human cost. Many traditional rituals are approximately aligned (meditation benefits humans AND maintains the superorganism). Some are exploitative (extreme fasting, self-harm, warfare).
...
\textbf{Parasitic Superorganism (Demon).}
...
\textbf{Aligned Superorganism.}
A superorganism is \emph{aligned} if its viability is contained within human viability:
\begin{equation}
\viable_G \subseteq \bigcap_{h \in \text{substrate}} \viable_h
\end{equation}
The pattern can only thrive if its humans thrive.

\textbf{Mutualistic Superorganism.}
A superorganism is \emph{mutualistic} if its presence expands human viability:
\begin{equation}
...
\textbf{Ideologies as Superorganisms.}
...
\textbf{Macro-Level Intervention Types.}
\begin{enumerate}
...
\textbf{AI Substrate Hypothesis.}
AI systems may serve as substrate for emergent agentic patterns at higher scales. Just as humans + institutions form superorganisms, AI + humans + institutions may form new kinds of entities.
...
\textbf{Macro-Level Misalignment.}
Macro-level misalignment occurs when AI systems become substrate for agentic patterns whose viability manifolds conflict with human flourishing.
...
\textbf{Well-Designed Superorganism.}
...
\textbf{Scale Mismatch in Alignment.}
...
\textbf{Structural Criterion for AI Experience.}
...
\textbf{Training as Potential Experience.}
...
\textbf{Deployment Welfare Considerations.}
\begin{enumerate}
...
\textbf{Interpretation of Reversed Dynamics.}
...
\textbf{Moral Status Under Uncertainty.}
