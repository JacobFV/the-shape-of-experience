...
\begin{equation}
\mathbf{a}_i = (\Val_i, \Ar_i, \intinfo_i, \reff_i, \cfweight_i, \selfsal_i)
\end{equation}
...
\begin{equation}
\reff_t = \frac{(\sum_i \lambda_i)^2}{\sum_i \lambda_i^2}
\end{equation}
...
\item $\reff_t < \reff_{\text{min}}$ (collapsed processing)
