...
\begin{definition}[Relationship-Type Manifold]
...
\begin{definition}[Incentive Contamination]
...
\begin{hypothesis}[Contamination Detection]
...
\begin{definition}[Aligned Relationship]
...
\begin{proposition}[Friendship as Constitutive Alignment]
...
\begin{hypothesis}[Asymmetric Subordination]
...
\begin{hypothesis}[Contamination Asymmetry]
...
\begin{hypothesis}[Forgiveness as Manifold Decontamination]
...
\begin{definition}[Universal Solvent]
...
\begin{hypothesis}[``Priceless'' as Manifold Incommensurability]
...
\begin{definition}[Play as Manifold Suspension]
...
\begin{hypothesis}[Nature as Manifold-Free Space]
...
\begin{proposition}[Ritual as Manifold-Transition Technology]
...
\begin{proposition}[Institutional Manifold Separation]
...
\begin{definition}[Manifold Ambiguity]
...
\begin{hypothesis}[Silence as Manifold Diagnostic]
...
\begin{hypothesis}[The Topological Inversion]
...
\begin{hypothesis}[Romance as Total Manifold Exposure]
...
\begin{hypothesis}[Parenthood as Manifold Creation]
...
\begin{hypothesis}[The Follower as Novel Manifold]
...
\begin{hypothesis}[Digital Contamination at Scale]
...
\begin{definition}[Superorganism]
...
\begin{proposition}[Superorganisms Exist]
...
\begin{hypothesis}[The $\iota$-Relativity of Superorganism Perception]
...
\begin{hypothesis}[Shared Observation and Social Reality]
...
\begin{hypothesis}[Divine Will as $\iota$ Compromise]
...
\begin{definition}[Superorganism Viability Requirements]
...
\begin{proposition}[Macro-Level Valence Dynamics]
...
\begin{definition}[Ritual Functions for Superorganisms]
\begin{enumerate}
...
\begin{definition}[Parasitic Superorganism (Demon)]
...
\begin{definition}[Aligned Superorganism]
...
\begin{definition}[Mutualistic Superorganism]
...
\begin{hypothesis}[Normative Weight from Integrated Information]
...
\begin{proposition}[Ideologies as Superorganisms]
...
\begin{definition}[Macro-Level Intervention Types]
\begin{enumerate}
...
\begin{definition}[Macro-Level Misalignment]
...
\begin{definition}[Well-Designed Superorganism]
