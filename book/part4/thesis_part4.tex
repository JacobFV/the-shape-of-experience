...
\begin{abstract}
Part IV develops the practical implications of the affect framework. I'll establish the seven-scale hierarchy of intervention---from neural circuits to civilizational patterns---and show that effective change requires scale-matched action. I'll ground normativity in the structure of self-maintaining systems, dissolving the is-ought gap by recognizing valence as a real structural property at the experiential scale. I'll develop a scale-relative account of truth and extend the framework to agentic systems at the social layer---gods, ideologies, institutions---analyzing their viability manifolds and the rituals that sustain them. I'll provide detailed intervention protocols at each scale, from individual affect regulation to organizational climate design to god-level restructuring. Finally, I'll draw implications for artificial intelligence, reframing alignment as a question about which emergent agentic patterns we instantiate and at what scale.
\end{abstract}
...
\begin{proposition}[Macro-Level Valence]
Superorganisms experience something analogous to valence: movement toward or away from viability boundaries. A religion losing members is ``suffering'' at its scale. A growing ideology is ``thriving.'' This is not metaphor---it is valence at the superorganism scale, measured by $\nabla d(\mathbf{s}_G, \partial\viable_G) \cdot \dot{\mathbf{s}}_G$.
\end{proposition}
