...
\begin{hypothesis}[Art as $\iota$ Technology]
...
\begin{hypothesis}[Science as $\iota$ Oscillation]
...
\begin{hypothesis}[$\iota$ Rigidity as Transdiagnostic Factor]
...
\begin{hypothesis}[Flow as Scoped $\iota$ Reduction]
...
\begin{hypothesis}[Awe as Scale-Triggered $\iota$ Collapse]
...
\begin{hypothesis}[Psychedelics as Pharmacological $\iota$ Reduction]
...
\begin{hypothesis}[Contemplative Practice as Trained $\iota$ Modulation]
