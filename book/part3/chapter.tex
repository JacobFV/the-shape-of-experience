...
Three streams of data. Three independent measurement modalities.

\begin{enumerate}
\item \textbf{Structure}: The geometric properties of internal activation space
\item \textbf{Signal}: The translated content of emergent communication
\item \textbf{Action}: The observable behavior in the environment
\end{enumerate}

The prediction: these three streams align in the ways the framework predicts.

When structure shows the suffering motif (negative valence, high integration, collapsed rank, high self-salience), the translated signal should express suffering-concepts, and the behavior should show suffering-patterns.

When structure shows the fear motif (negative valence, high counterfactual weight, high self-salience), the translated signal should express fear-concepts, and the behavior should show avoidance and hypervigilance.

When structure shows the curiosity motif (positive valence toward uncertainty, high counterfactual weight, low self-salience), the translated signal should express exploration-concepts, and the behavior should show approach and investigation.

Not because we trained alignment. Because structure is experience is expression.
