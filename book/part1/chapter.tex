...
\textbf{Teleology as Attractor Structure.}
...
\textbf{Far-from-Equilibrium System.}
...
\textbf{Generic Structure Formation.}
...
\textbf{Regulation Requires Modeling.}
...
\textbf{Belief State Sufficiency.}
...
\textbf{Information Bottleneck Necessity.}
...
\textbf{Compression Determines Ontology.}
...
\textbf{Attention Selects Trajectories.}
Let a system $\mathcal{S}$ inhabit a chaotic environment where small differences in observation lead to divergent action sequences. The system's attention pattern $\alpha: \mathcal{O} \to [0,1]$ weights which observations are processed at high fidelity and which are compressed or discarded. Because subsequent actions depend on processed observations, and those actions shape future states, the attention pattern $\alpha$ selects which dynamical trajectory the system follows from the space of trajectories consistent with its current state.
...
\textbf{Information Persistence and Branch Commitment.}
...
\textbf{Self-Model Inevitability.}
...
\textbf{Emergent Patterns in Cellular Automata.}
...
\textbf{Emergent Boundary in Discrete Substrate.}
...
\textbf{Substrate-Environment Prior.}
...
\textbf{Typicality of Self-Modeling Systems.}
...
\textbf{The Ladder Requires Heritable Variation.}\label{hyp:ladder-variation}
...
\textbf{Forcing Functions Increase Integration.}
\label{hyp:forcing-integration}
...
\textbf{Integrated Information ($\Phi$).}
