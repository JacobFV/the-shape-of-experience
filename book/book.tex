\documentclass[11pt,a4paper,openany,twocolumn]{book}
...
% --- Layout switching: 1-col breathing room with side margins ---
% Use \begin{widebreath}...\end{widebreath} around sections that need
% single-column layout with wide margins for phenomenological prose.
% These force page breaks (inherent to column switching in book class).
...
% Use \begin{widemargin}...\end{widemargin} for 1-col with a wide
...
% Connection box - single column, breakable
...
% Connection box - spans both columns (use connection* environment)
\newtcolorbox{connection*}{
  colback=green!5!white,
  colframe=green!60!black,
  title={\faBook\hspace{0.5em}Existing Theory},
