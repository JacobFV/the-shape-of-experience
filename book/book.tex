...
% Warning: caution about a claim or implication
...
\newcommand{\policy}{\pi}
% \value is a LaTeX internal (counter command) — use V directly if needed
\newcommand{\qfunc}{Q}
\newcommand{\reward}{r}
...
\newcommand{\effrank}[1][]{r_{\text{eff}\ifx&#1&\else,{#1}\fi}}
...
for Biological and Artificial Systems}\\[2em]
\includegraphics[width=0.55\textwidth]{ascii-art-cover}\\[2em]
{\large By Me}
\end{center}
\vfill
\newpage
