...
The CA gives exact definitions. Transformers give scale. Here is the protocol for extracting affect dimensions from transformer activations without human contamination.
