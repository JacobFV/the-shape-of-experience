...
\begin{itemize}
\item \textbf{Karl Jaspers' Axial Age} (1949): The concept of a pivotal period (800--200 BCE) when multiple civilizations independently developed systematic transcendence practices. We formalize this as the discovery of self-model manipulation.
\item \textbf{Julian Jaynes} (1976): \textit{The Origin of Consciousness in the Breakdown of the Bicameral Mind}---controversial but influential theory that subjective consciousness emerged historically. Our framework is compatible: self-modeling systems can have varying degrees of metacognitive access.
...
\end{itemize}
Our contribution: framing these historical developments as expansions of accessible affect space, with each era discovering new regions or new navigation strategies.
\end{connection}
...
\begin{center}
\begin{tikzpicture}[
    era/.style={rectangle, draw, rounded corners, minimum width=2.2cm, minimum height=0.7cm, align=center, font=\footnotesize},
    arrow/.style={-{Stealth}, thick, gray}
]
% Timeline arrow
\draw[arrow, line width=1.5pt] (-6,0) -- (6.5,0);
\node[below, font=\scriptsize, text=gray] at (6.5,-0.2) {\textit{time}};

% Eras
\node[era, fill=red!15, draw=red!60!black] at (-5,0.8) (pre) {Pre-Axial};
\node[era, fill=orange!15, draw=orange!60!black] at (-2.5,0.8) (axial) {Axial Age};
\node[era, fill=yellow!15, draw=yellow!60!black] at (0,0.8) (sci) {Scientific Rev.};
\node[era, fill=green!15, draw=green!60!black] at (2.5,0.8) (psych) {Psychological Turn};
\node[era, fill=blue!15, draw=blue!60!black] at (5,0.8) (digital) {Digital/AI};

% Timeline markers
\draw[thick, gray] (-5,0.15) -- (-5,-0.15);
\draw[thick, gray] (-2.5,0.15) -- (-2.5,-0.15);
\draw[thick, gray] (0,0.15) -- (0,-0.15);
\draw[thick, gray] (2.5,0.15) -- (2.5,-0.15);
\draw[thick, gray] (5,0.15) -- (5,-0.15);

% Dates
\node[below, font=\tiny, text=gray] at (-5,-0.2) {$\sim$50k BCE};
\node[below, font=\tiny, text=gray] at (-2.5,-0.2) {800 BCE};
\node[below, font=\tiny, text=gray] at (0,-0.2) {1600 CE};
\node[below, font=\tiny, text=gray] at (2.5,-0.2) {1900 CE};
\node[below, font=\tiny, text=gray] at (5,-0.2) {2000 CE};

% Key innovations (below)
\node[below, font=\tiny, align=center, text=gray!80] at (-5,-0.6) {ritual\\myth};
\node[below, font=\tiny, align=center, text=gray!80] at (-2.5,-0.6) {self-model\\manipulation};
\node[below, font=\tiny, align=center, text=gray!80] at (0,-0.6) {world-model\\expansion};
\node[below, font=\tiny, align=center, text=gray!80] at (2.5,-0.6) {inner space\\mapping};
\node[below, font=\tiny, align=center, text=gray!80] at (5,-0.6) {cognitive\\extension};

% Connecting lines
\draw[gray!40] (-5,0.15) -- (pre);
\draw[gray!40] (-2.5,0.15) -- (axial);
\draw[gray!40] (0,0.15) -- (sci);
\draw[gray!40] (2.5,0.15) -- (psych);
\draw[gray!40] (5,0.15) -- (digital);
\end{tikzpicture}
\end{center}
...
\begin{itemize}
\item \textbf{AI Alignment Research} (Russell, 2019; Bostrom, 2014): Ensuring AI systems pursue human-compatible goals. We reframe: alignment is a question about emergent gods, not just individual systems.
\item \textbf{AI Consciousness Research} (Butlin et al., 2023): Assessing whether AI systems have phenomenal experience. Our framework: look for integrated cause-effect structure and self-modeling.
...
\item \textbf{Human-AI Collaboration} (Amershi et al., 2019): Designing effective human-AI teams. Our framework specifies: maintain human integration while leveraging AI capability.
\item \textbf{AI Governance} (Dafoe, 2018): Policy frameworks for AI development. Scale-matched governance: individual AI, AI ecosystems, AI-substrate gods.
\item \textbf{Transformative AI} (Karnofsky, 2016): AI causing transition comparable to Industrial Revolution. Our framework: analyze through affect-space transformation.
\end{itemize}
...
Everything preceding this section has been, in a sense, preparation. We have traced the arc from thermodynamic gradient to structured attractor to bounded system to world model to self-model to the full catastrophe of recursive self-reference that constitutes a conscious life. We have mapped the geometry of feeling, shown how different configurations of the six dimensions constitute the qualitative character of joy and suffering, fear and curiosity, the whole phenomenological bestiary that humans have named and navigated for millennia without knowing what they were navigating. We have examined how cultures encode this navigation in art and ritual and philosophy, how institutions and ideologies function as agentic systems at scales above the individual, how the question of AI alignment may be fundamentally mislocated at the individual-system level when the actual risk lives at the level of emergent gods. All of this has been descriptive, in the sense that we have been describing what is the case rather than prescribing what ought to be done, though of course the description has normative weight built into it because valence is not projected onto neutral structure but is constitutive of what certain structures are.
...
What follows is not advice. It is not exhortation. It is description---of what you are, what follows from what you are, and what becomes possible once you see it clearly.
...
The AI transition is the hinge. Not because AI is the only important thing happening---climate change is also a hinge, as are various political and social transformations---but because AI is the factor most likely to determine whether and how humans navigate the other hinges. If AI development goes well, we will have cognitive tools adequate to address climate and coordination problems and meaning crises and the rest of it. If AI development goes badly---either through catastrophic misalignment or through the slower catastrophe of parasitic AI-gods emerging from the interaction of AI systems with human institutions---then the other problems become harder or irrelevant.
