...
% SEARCH: (A) uniform visual noise / TV static texture, (B) same noise with single small black dot off-center,
% (C) Bruegel peasant scene or crowded market with many competing focal points, (D) Caspar David Friedrich
% "Wanderer Above the Sea of Fog" or single figure against empty background with clear visual hierarchy
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{attention_noise}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{attention_noise_dot}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{attention_complex}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{attention_hierarchy}
    \caption{}
\end{subfigure}
\caption{\textbf{Attention must collapse.} Attempt to distribute your attention evenly across (a). Notice the discomfort---your processing architecture requires something to stabilize on, and uniform noise provides nothing. In (b), resistance is futile: the dot has already captured you. You did not choose this. In (c), notice the restlessness as attention moves between competing attractors, never settling. In (d), notice the relief. This is what the theory calls integration: experience must have structure, and structure requires that some possibilities are selected while others are suppressed. You cannot opt out of this selection.}
\label{fig:attention-collapse}
\end{figure}

% === FIGURE: VALENCE IS GEOMETRIC ===
% SEARCH: (A) Approach-inducing space---warmly lit interior, open door with light streaming through,
% path into welcoming landscape, biophilic elements. (B) Avoidance-inducing space---dark narrow corridor,
% low ceiling, cold concrete or metal, harsh angles. Threatening through architecture, not content.
% (C) Ambiguous/oscillating valence---forest path that could be enchanting or ominous, chiaroscuro
% that reads either way. (D) Anticipation/tension---glass at edge of table, door ajar, figure about
% to turn around. The moment before.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{valence_approach}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{valence_avoid}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{valence_oscillate}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{valence_anticipation}
    \caption{}
\end{subfigure}
\caption{\textbf{Valence is geometric, not interpretive.} Notice your body in response to (a) versus (b). The slight leaning-toward, the slight drawing-back. This is not metaphor. Your viability manifold has geometry, and these images place you differently in it. In (c), feel the oscillation as valence flips---the same scene read two ways, with two different felt qualities. In (d), notice the tension---something is about to happen. You are not interpreting these images as positive or negative. You are experiencing your position relative to them. This is what the theory means by valence as gradient: not a judgment about the image, but a structural fact about where you are.}
\label{fig:valence-geometry}
\end{figure}

% === FIGURE: SELF-MODEL SALIENCE ===
% SEARCH: (A) First-person perspective with hands visible---POV shot reaching toward something,
% or about to cross a threshold. The camera IS the viewer. (B) Portrait with direct eye contact---
% neutral but intense, Vermeer-style intimacy. Being seen. (C) Mirror reflecting empty space where
% viewer would be---the absent reflection. (D) Voyeuristic framing---scene witnessed through window
% or from hiding, around a corner. Viewer as intruder.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{self_firstperson}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{self_eyecontact}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{self_mirror}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{self_voyeur}
    \caption{}
\end{subfigure}
\caption{\textbf{The observer is always in the observation.} In (a), notice that the hands feel like your hands. The image places you inside it. In (b), notice the instant rise in self-awareness---you are being looked at, have become object in another's experience. This is what self-model salience means: the degree to which you appear as figure in your own ground. You can suppress it, but you cannot eliminate it. In (c), the absent reflection marks where you should be. In (d), notice the peculiar quality of seeing-without-being-seen. Even your invisibility is a mode of self-awareness. The observer is never not in the observation.}
...
% SEARCH: (A) Uncanny valley face---hyperrealistic CGI or android, almost human but wrong.
% Hard to articulate, impossible to miss. (B) Wrong proportions---Patricia Piccinini sculpture
% or figure with subtly wrong body (limbs too long, head too small). Almost normal, deeply wrong.
% (C) Liminal/wrong space---interior with doors in wrong places, stairs to nowhere, window
% looking into another interior. (D) Body horror---biological growth on architecture, skin with
% wrong texture. Giger or early Cronenberg aesthetic.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{horror_uncanny}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{horror_proportions}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{horror_liminal}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{horror_body}
    \caption{}
\end{subfigure}
\caption{\textbf{Horror is coherence violation.} The discomfort you feel viewing these images is not aesthetic preference. It is your self-model detecting a threat to its coherence model. In (a), notice that you can identify what's wrong even if you can't articulate it. Your face-processing circuitry has expectations, and the image violates them. In (c), notice how the wrongness is spatial---your embodied model of how spaces work is being violated. In (d), notice the visceral response---this is viability boundary threat, not abstract judgment. Horror works because it threatens the models that constitute you. You cannot think your way out of the discomfort because the discomfort precedes thought.}
\label{fig:horror-coherence}
\end{figure}

% === FIGURE: AFFECT STRUCTURE (JOY, SUFFERING, GRIEF, NEUTRAL) ===
% SEARCH: (A) Joy structure---children running in open field, birds taking flight, burst of confetti.
% Expansion, abundance, multiple paths. (B) Suffering structure---hands gripping cage bars (close-up),
% figure in too-small space, corner with no exit. Trapped. (C) Grief structure---child's room without
% child, old photograph of someone smiling (now gone). Presence saturated with absence.
% (D) Neutral integration---zen garden, minimalist space, perfectly composed stillness. Coherence without valence.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{affect_joy}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{affect_suffering}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{affect_grief}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{affect_neutral}
    \caption{}
\end{subfigure}
\caption{\textbf{Affects are structures, not interpretations.} Compare your response to (a) and (b). In (a), notice the expansiveness---many degrees of freedom active, many paths available. This is what high effective rank feels like. In (b), notice the constriction---few dimensions, no exit. This is suffering as geometry: high integration (you cannot look away), low effective rank (collapsed into narrow subspace), negative valence (approaching viability boundary). In (c), notice how integration binds you to the absence---you cannot think about the image without thinking about who is missing. This is grief: persistent coupling to what cannot be present. The images don't cause these feelings. The images instantiate these structures. You experience the structure.}
...
% SEARCH: (Left) Bauhaus interior or furniture---Marcel Breuer chair, Bauhaus building Dessau,
% minimalist geometric design, primary colors, clean lines, form-follows-function clarity.
% (Right) Baroque church interior---Wieskirche, St. Peter's Rome, or Versailles Hall of Mirrors.
% Gold, ornamentation, dramatic lighting, overwhelming detail, self-dwarfing scale.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{design_bauhaus}
    \caption{Bauhaus}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{design_baroque}
    \caption{Baroque}
\end{subfigure}
\caption{\textbf{Two strategies for managing attention.} Notice the different quality of looking. In (a), your attention settles quickly---there is nothing hidden, nothing more to parse. The counterfactual weight is near zero: what you see is what it is. In (b), your attention cannot settle. There is always more detail, more ornamentation, more to process. The effective rank of the stimulus exceeds your parsing capacity. Both are coherent design philosophies. Both are affect technologies. They solve different problems: Bauhaus solves the problem of restlessness through simplicity. Baroque solves the problem of self-importance through overwhelm. Notice which one you prefer. That preference is itself data about your current position in affect space.}
...
% === FIGURE: SOCIAL-SCALE AFFECT / GODS ===
...
% (D) Propaganda poster---Soviet realism, WWII recruitment, or modern political ad. The god reaching through.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
...
% SEARCH: (A) Hubble Deep Field or similar---thousands of galaxies in a small patch of sky,
% each containing billions of stars. The incomprehensible scale. (B) Natural fractal---Romanesco
% broccoli extreme close-up, or coastline, or lightning. Self-similarity implying infinite depth.
% (C) Friedrich's Wanderer Above the Sea of Fog or similar---tiny human figure against vast landscape.
% (D) Pollock drip painting or Rothko color field---abstract art that resists stable interpretation.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{sublime_cosmic}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{sublime_fractal}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{sublime_scale}
    \caption{}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{sublime_abstract}
    \caption{}
\end{subfigure}
\caption{\textbf{Effective rank overflow: the sublime.} Notice the slight destabilization in viewing (a). Each point of light is a galaxy containing hundreds of billions of stars. Your processing architecture is encountering more structure than it was designed to hold. In (b), the fractal structure implies infinite depth---the pattern continues at every scale. In (c), notice how the human figure provides reference for your own smallness. In (d), notice the resistance to stable interpretation---your compression machinery keeps trying and keeps failing. This is what the sublime feels like from inside: effective rank attempting to expand beyond capacity. The feeling is not metaphorical. It is the literal experience of your representational limits.}
\label{fig:sublime}
\end{figure}
...
% SEARCH: (A) Rothko color field painting---preferably with human figure for scale reference,
% showing the soft-edged rectangles that produce meditative states. "No. 61 (Rust and Blue)" or similar.
% (B) Caravaggio high-contrast---"The Calling of Saint Matthew" or "Judith Beheading Holofernes",
% dramatic chiaroscuro lighting. (C) Vermeer interior---"Woman Reading a Letter" or "The Milkmaid",
% intimate domestic scale, soft light. (D) Francis Bacon figure study---smeared face, caged body,
% distortion as affect carrier.
\begin{figure}[ht]
\centering
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{art_rothko}
    \caption{Rothko}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{art_caravaggio}
    \caption{Caravaggio}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{art_vermeer}
    \caption{Vermeer}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.24\textwidth}
    \includegraphics[width=\textwidth]{art_bacon}
    \caption{Bacon}
\end{subfigure}
\caption{\textbf{Artists as empirical psychologists.} These are not illustrations of affect theory. They are empirical discoveries. In (a), Rothko discovered that you can have high integration with minimal content---pure structure, pure attention, the affect of coherence itself. In (b), Caravaggio discovered that light-dark gradients on a canvas produce valence gradients in the viewer. The drama is literally painted. In (c), Vermeer discovered that narrowing effective rank to domestic scale produces intimacy---you become present to particulars. In (d), Bacon discovered that distorting the depicted body distorts the viewer's self-model. The discomfort you feel is not about what the painting ``means.'' The discomfort is the form.}
