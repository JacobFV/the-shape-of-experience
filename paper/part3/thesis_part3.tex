...
\mdfdefinestyle{keybox}{
  ...
  frametitlebackgroundcolor=blue!75!black,
...
\mdfdefinestyle{warnbox}{
  ...
  innertopmargin=10pt,
  innerbottommargin=10pt,
  frametitlebackgroundcolor=red!75!black,
  frametitlefont=\bfseries\color{white},
  frametitlerule=true,
  frametitlerulewidth=0pt
}
\mdfdefinestyle{phenombox}{
  ...
  innertopmargin=10pt,
  innerbottommargin=10pt,
  frametitlebackgroundcolor=purple!75!black,
  frametitlefont=\bfseries\color{white},
  frametitlerule=true,
  frametitlerulewidth=0pt
}
...
% --- callout environments using mdframed ---
\newenvironment{keyresult}{\begin{mdframed}[style=keybox, frametitle=Key Result]}{\end{mdframed}}
\newenvironment{phenomenal}{\begin{mdframed}[style=phenombox, frametitle=Phenomenal Correspondence]}{\end{mdframed}}
\newenvironment{warning}{\begin{mdframed}[style=warnbox, frametitle=Warning]}{\end{mdframed}}
