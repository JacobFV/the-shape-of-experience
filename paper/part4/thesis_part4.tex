...
\begin{itemize}
\item \textbf{Bronfenbrenner's Ecological Systems Theory} (1979): Nested systems from microsystem to macrosystem. My scales refine and extend this hierarchy, adding the neural level below and the ``god'' level above.
...
\item \textbf{Complexity Economics} (Arthur, 2015): Economies as complex adaptive systems with emergent macro-level patterns. My ``gods'' correspond to such emergent economic agents.
...
\begin{itemize}
\item \textbf{Durkheim's Collective Representations} (1912): Society as a sui generis reality with its own laws. My gods are Durkheimian collective entities given formal treatment.
...
\item \textbf{Actor-Network Theory} (Latour, 2005): Non-human actants participate in social networks. My gods are actants at the social scale.
...
\item \textbf{Egregores} (occult tradition): Collective thought-forms that take on autonomous existence. I formalize this intuition: sufficiently coherent belief-practice-institution complexes \emph{do} become agentic.
\end{itemize}
