...
The following dimensions form a toolkit for characterizing affect states. Not all dimensions are relevant to every phenomenon---different affects invoke different subsets. We present the primary dimensions developed in Parts I--II; empirical investigation may refine this set.
